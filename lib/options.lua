...
module.register_dev_section("Warps", function(ctx)
    ...
    draw_feeling_button(ctx, "Udjat", 1, 2, THEME.DWELLING, function ()
        feelingslib.feeling_set_with_chance(feelingslib.FEELING_ID.UDJAT)
    end)
    ctx:win_inline()
    draw_feeling_button(ctx, "Snakepit", 1, 2, THEME.DWELLING, function ()
        feelingslib.feeling_set_with_chance(feelingslib.FEELING_ID.SNAKEPIT)
    end)
    ctx:win_inline()
    draw_feeling_button(ctx, "Spiderlair", 1, 2, THEME.DWELLING, function ()
        feelingslib.feeling_set_with_chance(feelingslib.FEELING_ID.SPIDERLAIR)

        feelingslib.feeling_clear(feelingslib.FEELING_ID.SNAKEPIT)
    end)

    draw_feeling_button(ctx, "Black Market", 2, 2, THEME.JUNGLE, function ()
        feelingslib.feeling_set_with_chance(feelingslib.FEELING_ID.BLACKMARKET)

        feelingslib.feeling_clear(feelingslib.FEELING_ID.VAULT)
        feelingslib.feeling_set_with_chance(feelingslib.FEELING_ID.BLACKMARKET_ENTRANCE, {1})
